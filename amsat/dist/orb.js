  ...
  updateSatellites: function () {
    ...
    if (
      ...
      if (
        ...
        "t']" == (urlright = document.getElementById("chat").src.slice(-5)) &&
          !0 == bip &&
          jBeep("Beep.wav"),
        ...
        "i']" == (urlright = document.getElementById("chat").src.slice(-5)) &&
          !0 == bip &&
          jBeep("bell1.wav"),
...
function graphichelp() {
  (satactivity += "GHELP/"),
    ...
    null != popupwin && popupwin.close(),
    (popupwi = window.open("passhelp']", "win1", preferences)).setTimeout(
      "self.close()",
      72e4,
    );
}
